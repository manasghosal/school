...
public class ParentAttendanceAsyncTask extends AsyncTask<Void, Void, Integer>{
	...
	public ParentAttendanceAsyncTask(Context context, int task, String email, String uniqueID) {
		mContext = context;
		mTask = task;
		mEmail = email;
	...
	protected Integer doInBackground(Void... params) {
		...
		Request request = new Request.Builder()
				.url(Constant.SERVER_BASE_ADDRESS+"api/quicksoftuser/attendanceparent")
				.post(body)
				.build();
