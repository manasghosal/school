...
public class TeacherClassesAsyncTask extends AsyncTask<Void, Void, Integer>{
	...
	public TeacherClassesAsyncTask(Context context, int task, String email, String uniqueID) {
		mContext = context;
		mTask = task;
		mEmail = email;
	...
	protected Integer doInBackground(Void... params) {
		...
		Request request = new Request.Builder()
				.url(Constant.SERVER_BASE_ADDRESS+"api/quicksoftuser/schoolinfo")
				.post(body)
				.build();
