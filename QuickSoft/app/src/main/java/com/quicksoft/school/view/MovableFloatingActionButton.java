package com.quicksoft.school.view;
...
public class MovableFloatingActionButton extends FloatingActionMenu implements View.OnTouchListener {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                ...
                //LogUtils.i(dX + " "+ dY + " " +view.getX() + " "+ view.getY() + " "+downRawX + " "+downRawY);
                if(dX<-150.0f && dY <-900 )
                    return true;
                else
    ...
    public RelativeLayout.LayoutParams getCoordinatorLayout() {
        return coordinatorLayout;
    }

    public void setCoordinatorLayout(RelativeLayout.LayoutParams coordinatorLayout) {
