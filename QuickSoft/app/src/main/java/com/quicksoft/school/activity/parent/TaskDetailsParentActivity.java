...
public class TaskDetailsParentActivity extends AppCompatActivity implements View.OnClickListener, SyncCompleteCallback {
...
//            LogUtils.i("Position:" + position);
    ...
    public void setupToolbar(){
        ...
        mToolbarTitle.setText("Task Details");
    ...
    public void onClick(View view) {
        if(view == btnReply){
            ...
            if(NetworkUtils.isConnected()) {
                mSyncManager = new SyncManager(TaskDetailsParentActivity.this, TaskDetailsParentActivity.this);

                pDialog = new SimpleArcDialog(TaskDetailsParentActivity.this);
                ArcConfiguration configuration = new ArcConfiguration(TaskDetailsParentActivity.this);
                ...
                mSyncManager.parentSubmitTask(email, uniqueID, taskId);
            }else{
                Toasty.error(TaskDetailsParentActivity.this,"Check your internet connection", Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    public void onSyncComplete(int syncPage, int response, Object data) {
        if(syncPage==Constant.SYNC_PARENT_TASK_SUBMIT){
            if(response == Constant.SUCCESS) {
                ...
                if(respCode ==401 || respCode ==403){
                    ...
                    startActivity(new Intent(TaskDetailsParentActivity.this, LoginActivity.class));
                    finish();
                }
            }
        }
