...
public class FacultyAdapter extends RecyclerView.Adapter<FacultyAdapter.ViewHolder> {
    ...
    ArrayList<FacultyParent> govtBodyParentArrayList;
    private Context mContext;

    public FacultyAdapter(Context context, ArrayList<FacultyParent> govtBodyParentArrayList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = inflater.inflate(R.layout.adapater_faculty, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.btnPhone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setData(Uri.parse("tel:" + govtBodyParentArrayList.get(position).getPhone()));
