...
public class ParentTaskAsyncTask extends AsyncTask<Void, Void, Integer>{
	...
	public ParentTaskAsyncTask(Context context, int task, String email, String uniqueID) {
		mContext = context;
		mTask = task;
		mEmail = email;
	...
	protected Integer doInBackground(Void... params) {
		...
		Request request = new Request.Builder()
				.url(Constant.SERVER_BASE_ADDRESS+"api/quicksoftuser/taskstodoparent")
				.post(body)
				.build();
...
//		LogUtils.i(request.toString());
		try {
			...
			LogUtils.i(s);
			jObjectResult = new JSONObject(s);
