...
public class ParentClassesAsyncTask extends AsyncTask<Void, Void, Integer>{
	...
	public ParentClassesAsyncTask(Context context, int task, String email, String uniqueID) {
		mContext = context;
		mTask = task;
		mEmail = email;
