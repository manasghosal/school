...
public class LoginGoogleActivity extends AppCompatActivity implements View.OnClickListener, SyncCompleteCallback{
    ...
    public void login() {
        ...
        String googleID =  GlobalPreferenceManager.getGoogleId();
        ...
        if(valid)
        {
            ...
            pDialog.show();
            mSyncManager.userLogin("", "",userType, "",googleID,studentID);
        }
        ...
        if(syncPage==Constant.SYNC_LOGIN){
            if(response == Constant.SUCCESS) {
                try {
                    ...
                    GlobalPreferenceManager.setLoginType(Constant.LOGIN_WITH_GMAIL);
                    startActivity(new Intent(LoginGoogleActivity.this, OTPActivity.class));
                    finish();
