...
public class DriverDashboardAsyncTask extends AsyncTask<Void, Void, Integer>{


	private String  mEmail, uniqueID, vehicle_no;
	private int mTask;
	...
	public DriverDashboardAsyncTask(Context context, int task, String email, String uniqueID, String vehicle) {
		mContext = context;
		mTask = task;
		mEmail = email;
	...
	protected Integer doInBackground(Void... params) {
		...
		try {
			...
			jsonLoginInfo.put("VehicleNo", vehicle_no);
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		Request request = new Request.Builder()
				.url(Constant.SERVER_BASE_ADDRESS+"api/quicksoftuser/dboarddriver")
				.post(body)
				.build();
