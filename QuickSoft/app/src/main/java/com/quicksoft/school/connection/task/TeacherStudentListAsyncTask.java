...
public class TeacherStudentListAsyncTask extends AsyncTask<Void, Void, Integer>{


	private String  mEmail, uniqueID, classs, section;
	private int mTask;
	...
	public TeacherStudentListAsyncTask(Context context, int task, String email, String uniqueID, String classs, String section) {
		mContext = context;
		mTask = task;
		mEmail = email;
		this.classs = classs;
	...
	protected Integer doInBackground(Void... params) {
		...
		Request request = new Request.Builder()
				.url(Constant.SERVER_BASE_ADDRESS+"api/quicksoftuser/studentlistteacher")
				.post(body)
				.build();
