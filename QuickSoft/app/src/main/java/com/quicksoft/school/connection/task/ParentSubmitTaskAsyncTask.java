...
public class ParentSubmitTaskAsyncTask extends AsyncTask<Void, Void, Integer>{


	private String  mEmail, uniqueID, taskId;
	private int mTask;
	...
	public ParentSubmitTaskAsyncTask(Context context, int task, String email, String uniqueID, String taskId) {
		mContext = context;
		mTask = task;
		mEmail = email;
		this.taskId = taskId;
	...
	protected Integer doInBackground(Void... params) {
		...
		try {
			...
			jsonLoginInfo.put("AssignmentIdList", new JSONArray(list));
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		Request request = new Request.Builder()
				.url(Constant.SERVER_BASE_ADDRESS+"api/quicksoftuser/tasksdoneparent")
				.post(body)
				.build();
